...
def evaluate(
    ...
    """
    Evaluate trained RCV1 classifier.
    """
...
def main():
    ...
    print(
        "RCV1 BERT Multi-Label Training"
    )
    ...
    for epoch in range(EPOCHS):
        ...
        # ----------------------------------------------------
        # BERT explicitly remains in evaluation mode.
        # ----------------------------------------------------
